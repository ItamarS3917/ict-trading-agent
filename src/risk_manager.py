...
class RiskManager:
    ...
    def validate_trade(
        self, signal: dict, capital: float, current_positions: Optional[list[Position]] = None
    ) -> tuple[bool, str]:
        """
    ...
    def calculate_take_profit(
        self, entry_price: float, stop_loss: float, direction: str, rr_ratio: Optional[float] = None
    ) -> float:
        """
    ...
    def check_daily_loss_limit(
        self, starting_capital: float, current_capital: float
    ) -> tuple[bool, float]:
        """
    ...
    def _calculate_portfolio_risk(self, positions: list[Position], capital: float) -> float:
        """
