...
class NotificationSystem:
    ...
    def send_signal_alert(self, signal: dict) -> bool:
        ...
        if self.email_enabled:
            success = success and self._send_email(
                subject="🚨 ICT Trading Signal Alert", body=message
            )
    ...
    def send_trade_alert(self, trade: dict, alert_type: str = "ENTRY") -> bool:
        ...
        if self.email_enabled:
            success = success and self._send_email(
                subject=f"💰 Trade {alert_type} Alert", body=message
            )
    ...
    def send_error_alert(self, error_msg: str, context: Optional[dict] = None) -> bool:
        ...
        if self.email_enabled:
            success = success and self._send_email(subject="⚠️ ICT Agent Error Alert", body=message)
    ...
    def send_daily_summary(self, summary: dict) -> bool:
        ...
        if self.email_enabled:
            success = success and self._send_email(
                subject="📊 ICT Agent Daily Summary", body=message
            )
    ...
    def _format_signal_message(self, signal: dict) -> str:
        ...
        emoji = (
            "🟢"
            if signal.get("direction") == "LONG" or signal.get("direction") == "BULLISH"
            else "🔴"
        )
...
"""
    ...
    def _format_trade_message(self, trade: dict, alert_type: str) -> str:
        ...
        emoji_map = {"ENTRY": "📈", "EXIT": "💰", "STOP_LOSS": "🛑", "TAKE_PROFIT": "✅"}
...
"""
    ...
    def _send_email(self, subject: str, body: str) -> bool:
        ...
        if not self.email_enabled or not all(
            [self.smtp_server, self.email_from, self.email_to, self.email_password]
        ):
