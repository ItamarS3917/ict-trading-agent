...
class TestRiskManager:
    ...
    def test_validate_trade_success(self, risk_manager):
        ...
        signal = {"price": 100, "stop_loss": 95, "take_profit": 110, "direction": "LONG"}
        capital = 10000
    ...
    def test_validate_trade_max_positions(self, risk_manager):
        ...
        signal = {"price": 100, "stop_loss": 95, "take_profit": 110}
        capital = 10000
    ...
    def test_calculate_stop_loss_long(self, risk_manager):
        ...
        stop_loss = risk_manager.calculate_stop_loss(entry_price, "LONG", atr)
    ...
    def test_calculate_stop_loss_short(self, risk_manager):
        ...
        stop_loss = risk_manager.calculate_stop_loss(entry_price, "SHORT", atr)
    ...
    def test_calculate_take_profit_long(self, risk_manager):
        ...
        take_profit = risk_manager.calculate_take_profit(entry_price, stop_loss, "LONG")
    ...
    def test_calculate_take_profit_short(self, risk_manager):
        ...
        take_profit = risk_manager.calculate_take_profit(entry_price, stop_loss, "SHORT")
    ...
    def test_check_drawdown_limit_not_reached(self, risk_manager):
        ...
        limit_reached, drawdown = risk_manager.check_drawdown_limit(peak_capital, current_capital)
